...
module tb_spare_route_vrc;
    ...
    localparam [7:0] NOFAULT0  = 8'h0e;
    localparam [7:0] NOFAULT1  = 8'h0a;
    localparam [7:0] NOFAULT2  = 8'h0c;
    localparam [7:0] NOFAULT3  = 8'h04;
    localparam [7:0] NOFAULT4  = 8'he8;
    localparam [7:0] NOFAULT5  = 8'h01;
    localparam [7:0] NOFAULT6  = 8'h03;
    localparam [7:0] NOFAULT7  = 8'h02;
    localparam [7:0] NOFAULT8  = 8'h02;
    localparam [7:0] NOFAULT9  = 8'h02;
    localparam [7:0] NOFAULT10 = 8'h03;
    localparam [7:0] NOFAULT11 = 8'h03;
    localparam [7:0] NOFAULT12 = 8'h00;
    localparam [7:0] NOFAULT13 = 8'h03;
    localparam [7:0] NOFAULT14 = 8'h01;
    localparam [7:0] NOFAULT15 = 8'h00;

    localparam [7:0] REPAIR0  = 8'h0e;
    localparam [7:0] REPAIR1  = 8'h06;
    localparam [7:0] REPAIR2  = 8'h0e;
    localparam [7:0] REPAIR3  = 8'h01;
    localparam [7:0] REPAIR4  = 8'h68;
    localparam [7:0] REPAIR5  = 8'h00;
    localparam [7:0] REPAIR6  = 8'h01;
    localparam [7:0] REPAIR7  = 8'h04;
    localparam [7:0] REPAIR8  = 8'h01;
    localparam [7:0] REPAIR9  = 8'h02;
    localparam [7:0] REPAIR10 = 8'h00;
    localparam [7:0] REPAIR11 = 8'h01;
    localparam [7:0] REPAIR12 = 8'h02;
    localparam [7:0] REPAIR13 = 8'h00;
    localparam [7:0] REPAIR14 = 8'h03;
    localparam [7:0] REPAIR15 = 8'h02;
    ...
    initial begin
        ...
        sweep_rows(8'he8);
        xread(12'h01c, rd);
        expect_eq(rd, 32'h0000_0003, "no-fault uses A1+AS");

        set_fault_disable_a1();
        xread(12'h018, rd);
        expect_eq(rd, 32'h0000_0013, "fault readback");
        expect_mask_fit(8'h88, 4'd6, "disable A1 mask/fitness");
        sweep_rows(8'h88);

        set_fault_disable_route_out_in1();
        expect_mask_fit(8'hcc, 4'd6, "disable route O.in1 mask/fitness");
