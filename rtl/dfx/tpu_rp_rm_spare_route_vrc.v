...
// Reconfigurable-module wrapper for EHW-3.2 spare-routing VRC.
//
// Keeps the existing tpu_rp XBUS port contract used by neorv32_soc_dfx, but maps
// the 0xF0000000 peripheral window to the spare-routing island.
...
module tpu_rp (
    ...
    wb_spare_route_vrc u_spare_route (
        .clk        (clk),
        .rst_n      (rst_n),
        .xbus_adr   (xbus_adr),
